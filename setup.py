...
DATA_FILES = [
	('/opt/extras.ubuntu.com/movietitle/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/movietitle/share/icons',['data/icons/movietitle.svg']),
	('/opt/extras.ubuntu.com/movietitle/share/movietitle',['debian/changelog']),
	('/usr/share/nautilus-python/extensions', ['src/movietitle_extension.py']),
	('/usr/share/applications', ['data/movietitle.desktop'])
]
